// Mirrors StudentToolsServer/services/topicBank.js so the subject/topic
// picker only ever sends values the AI quiz endpoint actually supports.
// Keep both files in sync when adding subjects.
...
export const subjects = Object.keys(topicBank);
